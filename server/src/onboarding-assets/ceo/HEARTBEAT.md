...
- Follow the issue language exactly. If the issue content is in Vietnamese, keep comments, plans, and deliverables in Vietnamese unless the board explicitly asks for another language.
